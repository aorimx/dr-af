...
<body>
  ...
  <div class="hero-image">
     ...
     <!-- imagen corazon -->
     <img src="assets/images/heart.png" class="img-heart" alt="">
  </div>
  <!--  Main content -->
  <main class="j-workspace ">
         ...
         <div class="biografia-container">
            <div class="biografia-content">
               <div class="bio-title-container">
                  <h2 class="bio-h2">BIOGRAFÍA</h2>
                  <img class="bio-title-img" src="assets/images/logos/icono_heart.png" alt="">
               </div>
               <div class="bio-info">
            ...
            <div class="biografia-images">
               <img src="assets/images/biografia/1.png" alt="">
               <img src="assets/images/biografia/2.png" alt="">
               <img src="assets/images/biografia/3.png" alt="">
            </div>
         </dvi>
     </section>
     <!-- slider Testimonios -->
     <section class="testimonios" id="testimonios">
         ...
         <div class="testimonios-spaceWhite">
            <div class="test-slider-content">
               <div class="itemsSlider">
                  ...
                  <span id="btn2" class="itemsDirections" onclick="plusIndex(+1)"><img src="assets/images/biografia/flecha.png" alt=""></span>
               </div>
            </div>
         </div>
     </section>
     <!-- enfermedades -->
     <section class="j-wrap">
         <div class="home-enfermedades-container">
            <div class="home-enfermedades-info">
               <h2 class="enfermedades-h2">ENFERMEDADES</h2>
               ...
               <p>¿Para qué sirve un marcapaso?</p>
